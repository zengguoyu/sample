...
public class CustomAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
		...
		try {
			...
			UserDetailsService userService=this.getUserDetailsService();
			if(userService instanceof UserLoginService) {
				UserLoginService loginService=		(UserLoginService) userService;

				loadedUser =loginService.loadUserByUsername(username,details.getAppId());
			}else {
